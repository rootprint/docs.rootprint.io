...
- **Pull-based sources**: ingest from Amazon Kinesis, Apache Kafka, Apache Pulsar, or files announced over SQS
- **Index management**: create, configure, and delete Quickwit indexes and their sources from the admin UI
