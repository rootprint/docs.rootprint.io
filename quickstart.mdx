...
<Steps>
  <Step title="Install Rootprint">
    ...
    ```bash
    curl -O https://raw.githubusercontent.com/rootprint/docs.rootprint.io/main/docs/files/docker-compose.yml
    docker compose up -d
    ```
...
<Step title="Create the admin account">
  ...
  <Step title="Create an ingest API key">
    ...
    1. In the top navigation, go to **Administration → API keys**.
