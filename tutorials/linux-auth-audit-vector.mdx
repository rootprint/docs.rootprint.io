...
- **`401`, `403`, `413`, `415` from Rootprint** — same four codes as a misconfigured Vector setup of any kind. See [Send logs with Vector](/send-logs/log-agents/vector#troubleshooting) for full diagnoses.
