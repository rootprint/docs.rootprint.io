...
- Quickwit `0.9.0`. Earlier releases are not supported. See [Environment variables](/configuration/environment-variables).
...
<CardGroup cols={2}>
	...
	<Card title="Service health" icon="activity" href="/traces/services">
		Request rate, error rate, latency, downstream calls, and failing spans, from the same spans.
	</Card>
</CardGroup>
