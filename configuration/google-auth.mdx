...
<Steps>
  <Step title="Create OAuth credentials in Google Cloud Console">
    ...
    - **Authorized redirect URI:** `https://<your-rootprint>/api/auth/callback/google`

    Replace `<your-rootprint>` with the host of your Rootprint instance. After saving, copy the **Client ID** and **Client Secret**. You will need them in the next step.
  ...
  <Step title="Save the configuration">
    ...
    <Note>
      ...
      editing them takes effect on the next Google sign-in attempt. Open sessions stay open.
    </Note>
...
Removing Google auth ends every session of every Google-linked user. Those users keep their
