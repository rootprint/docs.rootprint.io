...
3. Create an [ingest API key](/api/overview) scoped to the index and route writes through the [NDJSON gateway](/send-logs/http) or, for OpenTelemetry-shaped data, the [OTLP endpoint](/send-logs/otlp).
