...
description: 'Define a custom index with your own schema, tokenizers, and retention from the Rootprint Create-index form.'
---
...
Starts with a letter; 3–255 characters of letters, digits, `-`, or `_`. This is the index ID. Ingest requests never name it — the ingest API key you scope to this index is what routes writes here.
