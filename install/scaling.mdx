...
through object storage and the metastore, not a local disk. That decoupling is what lets the cluster
...
How far you scale is up to you and driven by your workload: add **indexers** when ingest throughput
...
Size searchers by query concurrency and aggregation load, not by total data volume — adding or
removing them never moves index data.
